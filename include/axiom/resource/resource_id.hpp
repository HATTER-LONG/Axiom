 ...
 * @brief Canonical, copyable identifier for a registered Axiom resource.
 */
 ...
 *       processes or Axiom instances.
 */
class AXIOM_API ResourceId {
public:
    ResourceId() = delete;
...
template <> struct std::hash<axiom::resource::ResourceId> {
    /**
     ...
     */
    [[nodiscard]] std::size_t operator()(const axiom::resource::ResourceId& id) const noexcept {
